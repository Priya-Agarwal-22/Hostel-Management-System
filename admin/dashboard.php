                ...
                <div class="container text-center">
                    <div class="row"> 
                        <div class="col-md-4 col-lg-4 col-sm-4">
                            <div class="box" style="background-color: rgb(82, 82, 142); margin-left: -30vh;">
...
?>
                            ...
                            <div class="boxx" style="margin-left: -30vh;">
                                <div class="txt" style="width: calc(100%-10%); display: inline-block;">
                                    <a href="manage-student.php" style="color:black;">Full details</a>
                                </div>
                                <div class="icon" style="width: 10%; display: inline-block;">
                            ...
                            <div  class="col-md-4 col-lg-4 col-sm-4">
                                <div class="box" style="background-color:rgb(59, 225, 59); margin-left: -7vh;">
                                <div class="stat-panel text-center">					
													<div class="stat-panel-number h1 "></div>
													<?php
...
?>												
                                ...
                                <div class="boxx" style="margin-left: -7vh;">
                                    <div class="txt" style="width: calc(100%-10%); display: inline-block;">
                                        <a href="manage-room.php" style="color:black;">see all</a>
                                    </div>
                                    <div class="icon" style="width: 10%; display: inline-block;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
                            ...
                            <div  class="col-md-4 col-lg-4 col-sm-4">
                                <div class="box" style="background-color:#0dcaf0; margin-left: 15vh;">
                                <div class="stat-panel text-center">					
													<div class="stat-panel-number h1 "></div>
													<?php
...
?>												
                                ...
                                <div class="boxx" style="margin-left: 15vh;">
                                    <div class="txt" style="width: calc(100%-10%); display: inline-block;">
                                        <a href="manage-courses.php" style="color:black;">see all</a>
                                    </div>
                                    <div class="icon" style="width: 10%; display: inline-block;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
