...
<div class="outer">
        <h1 style="text-align: left;">Add a Room</h1>
        <hr>
        ...
        <div class="boxx">
            <form id="myform">
                <div class="row mb-3">
                    <label for="inputcode" class="col-sm-3 col-form-label">Select Seater</label>
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="seater" required="required">
                ...
                <div class="row mb-3">
                    <label for="inputcode" class="col-sm-3 col-form-label">Room No.</label>
                    <div class="col-sm-10">
                        <input type="code" class="form-control" name="rmno" id="rmno" value="" required="required">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputcode" class="col-sm-3 col-form-label">Fee (Per Student)</label>
                    <div class="col-sm-10">
                        <input type="code" class="form-control" name="fee" id="fee" value="" required="required">
                    </div>
                </div>
                <div class="col-sm-6 col-sm-offset-4" style="width: 100%;">
                  <input type="button" id="submit" name="update" Value="Create Room" class="btn btn-primary" style="margin-left: 40%;">
                </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"
    ...
    <script>
      $("#submit").on("click",function(){
          var Form = $('#myform')[0];
          $.ajax({
            url: "ajax/process-createroom.php",
            type: "post",
            ...
            success:function(data){ 
              if(data == 'Exists') 
              {
                toastr.error('Room already exists');
              }
                  toastr.success('Room has been added successfully.');
                  console.log(data);
                  $("input").val("");
            }
          });
