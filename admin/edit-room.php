...
<div class="outer">
        <h1 style="text-align: left;">Edit Room Details</h1>
        </br>
	...
	$ret="select * from rooms where id=?";
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
                <div class="row mb-3">
                    <label for="inputcode" class="col-sm-3 col-form-label">Seater</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="rmno" id="rmno" value="<?php echo $row->room_no;?>" required="required">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputcode" class="col-sm-3 col-form-label">Fee (Per Student)</label>
                    <div class="col-sm-10">
                        <input type="code" class="form-control" name="fee" id="fee" value="<?php echo $row->fees;?>" required="required">
                    </div>
                </div>
<?php } ?>
                <div class="col-sm-6 col-sm-offset-4" style="width: 100%;">
                  <input type="button" id="submit" name="update" Value="Edit Room" class="btn btn-primary" style="margin-left: 40%;">
                </div>
            </form>
        </div>
    </div>
