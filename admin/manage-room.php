...
<div class="outer">
        <h1 style="text-align: left;">Manage Room</h1>
        </br>
            ...
            <table class="table table-bordered" id="userTable">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="text-align: center;">Seater</th>
                        <th scope="col" style="text-align: center;">Room No.</th>
                        <th scope="col" style="text-align: center;">Fees (PM)</th>
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            for (var i = 0; i < len; i++) {
              ...
              var room_no = response[i].room_no;
              var fees = response[i].fees;
              ...
              var tr_str = "<tr>" +
                              ...
                              "<td align='center'>" +
                                "<a href='edit-room.php?id=" + id + "' style='color:black;'>" +
