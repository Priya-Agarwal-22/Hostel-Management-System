...
<div class="outer">
        <h1 style="text-align: left;">Add Courses</h1>
        <hr>
        ...
        <div class="boxx">
            <form id="myform">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="" name="cc" required="required">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="cnf" id="cnf" value="" required="required">
                    </div>
                </div>
                <div class="col-sm-6 col-sm-offset-4" style="width: 100%;">
<input type="button" id="submit" name="update" Value="Add Course" class="btn btn-primary" style="margin-left: 40%;">
</div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"
    ...
    <script>
      $("#submit").on("click",function(){
          var Form = $('#myform')[0];
          $.ajax({
            url: "ajax/process-addcourses.php",
            type: "post",
            ...
            success:function(data){  
                  toastr.success('Course added succsesfully.');
                  console.log(data);
                  $("input").val("");
            }
          });
